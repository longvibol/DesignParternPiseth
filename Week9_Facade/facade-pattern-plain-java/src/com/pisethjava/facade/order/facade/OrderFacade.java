package com.pisethjava.facade.order.facade;
...
public final class OrderFacade {
	...
	public OrderFacade(CustomerService c, OrderValidator v, InventoryService i, PaymentService p, ShippingService s,
			InvoiceService n, NotificationService notify, AuditService a) {
		this.c = c;
		this.v = v;
		this.i = i;
		this.p = p;
	...
	public PlaceOrderResult placeOrder(OrderRequest r) {
		...
		return new PlaceOrderResult(r.orderNumber(), pay.transactionId(), ship.shipmentNumber(), inv.invoiceNumber(),
				"ORDER_CREATED");
	}
}
